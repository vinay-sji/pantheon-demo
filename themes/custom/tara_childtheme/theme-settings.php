 ...
 */
function tara_childtheme_form_system_theme_settings_alter(&$form, FormStateInterface &$form_state, $form_id = NULL) {
  $img_path = $GLOBALS['base_url'] . '/' . drupal_get_path('theme', 'tara_childtheme') . '/images/tarapro.jpg';
  $img = '<img src="'.$img_path.'" alt="image" />';
  $form['tara_childtheme'] = [
    '#type'       => 'vertical_tabs',
  ...
  $form['social']['all_icons']['all_icons_show'] = [
    ...
    '#default_value' => theme_get_setting('all_icons_show', 'tara_childtheme'),
  ...
  $form['social']['facebook']['facebook_url'] = [
    ...
    '#default_value' => theme_get_setting('facebook_url', 'tara_childtheme'),
  ];
  ...
  $form['social']['twitter']['twitter_url'] = [
    ...
    '#default_value' => theme_get_setting('twitter_url', 'tara_childtheme'),
  ];
  ...
  $form['social']['instagram']['instagram_url'] = [
    ...
    '#default_value' => theme_get_setting('instagram_url', 'tara_childtheme'),
  ];
  ...
  $form['social']['linkedin']['linkedin_url'] = [
    ...
    '#default_value' => theme_get_setting('linkedin_url', 'tara_childtheme'),
  ];
  ...
  $form['social']['youtube']['youtube_url'] = [
    ...
    '#default_value' => theme_get_setting('youtube_url', 'tara_childtheme'),
  ];
  ...
  $form['social']['vimeo']['vimeo_url'] = [
    ...
    '#default_value' => theme_get_setting('vimeo_url', 'tara_childtheme'),
  ];
  ...
  // Social -> vk.com url.
   ...
   $form['social']['vk']['vk_url'] = [
       ...
       '#default_value' => theme_get_setting('vk_url', 'tara_childtheme'),
   ];
   ...
   $form['social']['whatsapp']['whatsapp_url'] = [
       ...
       '#default_value' => theme_get_setting('whatsapp_url', 'tara_childtheme'),
   ];
   ...
   $form['social']['github']['github_url'] = [
       ...
       '#default_value' => theme_get_setting('github_url', 'tara_childtheme'),
   ];
   ...
   $form['social']['telegram']['telegram_url'] = [
     ...
     '#default_value' => theme_get_setting('telegram_url', 'tara_childtheme'),
   ];
  ...
  $form['slider']['slider_enable_option']['slider_show'] = [
    ...
    '#default_value' => theme_get_setting('slider_show', 'tara_childtheme'),
  ...
  $form['slider']['slider_image_section']['slider_image'] = [
    ...
    '#default_value'  => theme_get_setting('slider_image', 'tara_childtheme'),
  ...
  $form['slider']['slider_time_field']['slider_time'] = [
    '#type'          => 'number',
    '#default_value' => theme_get_setting('slider_time', 'tara_childtheme'),
  ...
  $form['slider']['slider_dots_field']['slider_dots'] = [
    ...
    '#options' => array(
      'true' => t('Show'),
      'false' => t('Hide'),),
    '#default_value' => theme_get_setting('slider_dots', 'tara_childtheme'),
  ...
  $form['slider']['slider_code'] = [
    '#type'          => 'textarea',
    '#title'         => t('Slider Code'),
    '#default_value' => theme_get_setting('slider_code', 'tara_childtheme'),
  ...
  $form['sidebar']['front_sidebars']['front_sidebar'] = [
    ...
    '#default_value' => theme_get_setting('front_sidebar', 'tara_childtheme'),
  ...
  $form['content']['google_font_section']['google_font'] = [
    ...
    '#default_value' => theme_get_setting('google_font', 'tara_childtheme'),
  ...
  $form['content']['comment']['comment_user_pic'] = [
    ...
    '#default_value' => theme_get_setting('comment_user_pic', 'tara_childtheme'),
  ...
  $form['content']['node']['node_author_pic'] = [
    ...
    '#default_value' => theme_get_setting('node_author_pic', 'tara_childtheme'),
  ...
  $form['content']['node']['node_tags'] = [
    '#type'          => 'checkbox',
    '#title'         => t('Node Tags'),
    '#default_value' => theme_get_setting('node_tags', 'tara_childtheme'),
  ...
  $form['footer']['scrolltotop']['scrolltotop_on'] = [
    ...
    '#default_value' => theme_get_setting('scrolltotop_on', 'tara_childtheme'),
  ...
  $form['footer']['copyright']['copyright_text'] = [
    ...
    '#default_value' => theme_get_setting('copyright_text', 'tara_childtheme'),
  ...
  $form['insert_codes']['css']['css_custom']['css_extra'] = [
    ...
    '#default_value' => theme_get_setting('css_extra', 'tara_childtheme'),
  ...
  $form['insert_codes']['css']['css_code'] = [
    ...
    '#default_value' => theme_get_setting('css_code', 'tara_childtheme'),
